<div align="center">
  <a href="https://github.com/scribe-org/Conjugate-iOS"><img src="https://raw.githubusercontent.com/scribe-org/Organization/main/logo/conjugate/ConjugateGitHubBanner.png" width=1024 alt="Conjugate Logo"></a>
</div>
...
[![version](https://img.shields.io/github/v/release/scribe-org/Conjugate-iOS?color=%2300550&sort=semver&label=%20)](https://github.com/scribe-org/Conjugate-iOS/releases/)
[![issues](https://img.shields.io/github/issues/scribe-org/Conjugate-iOS?label=%20&logo=github)](https://github.com/scribe-org/Conjugate-iOS/issues)
[![language](https://img.shields.io/badge/Swift%205-F0513C.svg?logo=swift&logoColor=ffffff)](https://github.com/scribe-org/Conjugate-iOS/blob/main/CONTRIBUTING.md)
[![license](https://img.shields.io/github/license/scribe-org/Conjugate-iOS.svg?label=%20)](https://github.com/scribe-org/Conjugate-iOS/blob/main/LICENSE.txt)
[![coc](https://img.shields.io/badge/Contributor%20Covenant-ff69b4.svg)](https://github.com/scribe-org/Conjugate-iOS/blob/main/.github/CODE_OF_CONDUCT.md)
...
**Conjugate-iOS** is a verb conjugation app that leverages [Scribe](https://github.com/scribe-org) language data infrastructure. Packs of verb data can be downloaded into the app and the search functionality works across all languages that have been downloaded.

Conjugate is fully open-source and does not collect usage data or ask for system access. Feature data is sourced from [Wikidata](https://www.wikidata.org/) and stored in-app, meaning Conjugate is a highly responsive experience that does not require an internet connection.
...
Please also see the [contribution guidelines](https://github.com/scribe-org/Conjugate-iOS/blob/main/CONTRIBUTING.md) if you are interested in contributing to Conjugate-iOS. Work that is in progress or could be implemented is tracked in the [issues](https://github.com/scribe-org/Conjugate-iOS/issues) and [projects](https://github.com/scribe-org/Conjugate-iOS/projects).

> [!NOTE]\
> Just because an issue is assigned on GitHub doesn't mean that the team isn't interested in your contribution! Feel free to write [in the issues](https://github.com/scribe-org/Conjugate-iOS/issues) and we can potentially reassign it to you.

Those interested can further check the [`-next release-`](https://github.com/scribe-org/Conjugate-iOS/labels/-next%20release-) and [`-priority-`](https://github.com/scribe-org/Conjugate-iOS/labels/-priority-) labels in the [issues](https://github.com/scribe-org/Conjugate-iOS/issues) for those that are most important, as well as those marked [`good first issue`](https://github.com/scribe-org/Conjugate-iOS/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) that are tailored for first time contributors. For those new to coding or our tech stack, we've collected [links to helpful documentation pages](https://github.com/scribe-org/Conjugate-iOS/blob/main/CONTRIBUTING.md#learning-the-tech) in the [contribution guidelines](https://github.com/scribe-org/Conjugate-iOS/blob/main/CONTRIBUTING.md).

After your first few pull requests organization members would be happy to discuss granting you further rights as a contributor, with a maintainer role then being possible after continued interest in the project. Scribe seeks to be an inclusive and supportive organization. We'd love to have you on the team!

### Ways to Help [`⇧`](#contents)

- [Reporting bugs](https://github.com/scribe-org/Conjugate-iOS/issues/new?assignees=&labels=bug&template=bug_report.yml) as they're found 🐞
- Working on [new features](https://github.com/scribe-org/Conjugate-iOS/issues?q=is%3Aissue+is%3Aopen+label%3Afeature) ✨
...
- [Documentation](https://github.com/scribe-org/Conjugate-iOS/issues?q=is%3Aissue+is%3Aopen+label%3Adocumentation) for onboarding and project cohesion 📝
- Adding language data to [Scribe-Data](https://github.com/scribe-org/Scribe-Data/issues) via [Wikidata](https://www.wikidata.org/)! 🗃️
- [Sharing Conjugate-iOS](https://github.com/scribe-org/Conjugate-iOS/issues/181) with others! 🚀
...
The [designs for Scribe](https://www.figma.com/file/c8945w2iyoPYVhsqW7vRn6/scribe_public_designs?node-id=405%3A464) are made using [Figma](https://www.figma.com). Those with interest in contributing can [open a design issue](https://github.com/scribe-org/Conjugate-iOS/issues/new?assignees=&labels=design&template=design_improvement.yml) to make suggestions! Design related issues are marked with the [`design`](https://github.com/scribe-org/Conjugate-iOS/issues?q=is%3Aopen+is%3Aissue+label%3Adesign) label.
...
>
> - e.g. Cloning now becomes `git clone git@github.com:<your-username>/Conjugate-iOS.git`
>
...
4. Open the Conjugate-iOS directory in Xcode

5. In order to run Conjugate on an emulator:
...
- July: [Blog post on Hashnode](https://jagmarcel.hashnode.dev/gsoc-2024-midterm-report) providing an midterm report on the localization and translation expansion for [Conjugate-iOS](https://github.com/scribe-org/Conjugate-iOS)
- July: [Blog post on Hashnode](https://jagmarcel.hashnode.dev/my-first-experiences-with-gsoc) about the initial steps towards the localization of [Conjugate-iOS](https://github.com/scribe-org/Conjugate-iOS)
...
- August: [Conjugate-iOS final submission report for Google Summer of Code 2023](https://saurabhjamadagni.hashnode.dev/gsoc-23-final-work-submission)
- June: [Conjugate-iOS development blog post on Nested UITableViews & Apple's built-in ViewControllers in app menu](https://saurabhjamadagni.hashnode.dev/nested-uitableviews-apples-built-in-viewcontrollers) for [GSoC '23](https://www.mediawiki.org/wiki/Google_Summer_of_Code/2023#Accepted_projects:~:text=links%3A%20Phabricator%20issue-,3.%20Adding%20a%20Menu%20and%20Keyboards%20to%20Scribe%2DiOS,-%5Bedit%5D)
...
- March: [Blog post](https://tech-news.wikimedia.de/en/2022/03/18/lexicographical-data-for-language-learners-the-wikidata-based-app-scribe/) on [Conjugate-iOS](https://github.com/scribe-org/Conjugate-iOS) for [Wikimedia Tech News](https://tech-news.wikimedia.de/en/homepage/) ([DE](https://tech-news.wikimedia.de/2022/03/18/sprachenlernen-mit-lexikografische-daten-die-wikidata-basierte-app-scribe/) / [Tweet](https://twitter.com/wikidata/status/1507335538596106257?s=20&t=YGRGamftI-5B_VwQ_bFRhA))
...
Many thanks to all the [Conjugate-iOS contributors](https://github.com/scribe-org/Conjugate-iOS/graphs/contributors)! 🚀

<a href="https://github.com/scribe-org/Conjugate-iOS/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=scribe-org/Conjugate-iOS" />
</a>
